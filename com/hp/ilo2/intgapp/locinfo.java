...
/*  47 */   private String lstrVersion = "0001";
/*     */   
/*  49 */   public String rcErrMessage = "";
/*     */   
...
/*     */     
/*     */     try {
/* 544 */       if (null == this.document) {
/* 545 */         b = 1;
/*     */       } else {
/*     */         
/* 548 */         Element element = this.document.getElementById(str1);
/* 549 */         if (null == element) {
/* 550 */           b = 2;
/*     */         } else {
/*     */           
/* 553 */           NodeList nodeList = element.getChildNodes();
/* 554 */           if (null == nodeList) {
/* 555 */             b = 3;
/*     */           } else {
/*     */             
/* 558 */             str2 = nodeList.item(0).getNodeValue();
/* 559 */             if (null == str2) {
/* 560 */               b = 4;
/*     */             }
/*     */             else {
...
/* 572 */     if (false == bool) {
/* 573 */       str2 = "LS_NF";
/* 574 */       System.out.println("LSFNound:" + str1 + "rval:" + b);
/*     */     } 
/*     */     
/* 577 */     return str2;
/*     */   }
...
/*     */     try {
/* 592 */       NodeList nodeList = this.document.getElementsByTagName("javaIRC");
/*     */       
/* 594 */       for (byte b = 0; b < nodeList.getLength(); b++) {
/* 595 */         Node node = nodeList.item(b);
/* 596 */         if (node.getNodeType() == 1) {
/* 597 */           Element element = (Element)node;
/*     */           
/* 599 */           NodeList nodeList1 = element.getElementsByTagName("menu");
/*     */           
/* 601 */           for (byte b1 = 0; b1 < nodeList1.getLength(); b1++) {
/* 602 */             Element element1 = (Element)nodeList1.item(b1);
/* 603 */             NodeList nodeList5 = element1.getChildNodes();
/*     */           } 
/*     */ 
/*     */ 
/*     */ 
/*     */           
/* 609 */           NodeList nodeList2 = element.getElementsByTagName("dialog");
/*     */           
/* 611 */           for (byte b2 = 0; b2 < nodeList2.getLength(); b2++) {
/* 612 */             Element element1 = (Element)nodeList2.item(b2);
/* 613 */             NodeList nodeList5 = element1.getChildNodes();
/*     */           } 
/*     */ 
/*     */ 
/*     */ 
/*     */           
/* 619 */           NodeList nodeList3 = element.getElementsByTagName("status");
/*     */           
/* 621 */           for (byte b3 = 0; b3 < nodeList3.getLength(); b3++) {
/* 622 */             Element element1 = (Element)nodeList3.item(b3);
...
/*     */ 
/*     */           
/* 629 */           NodeList nodeList4 = element.getElementsByTagName("tooltip");
/*     */           
/* 631 */           for (byte b4 = 0; b4 < nodeList4.getLength(); b4++) {
/* 632 */             Element element1 = (Element)nodeList4.item(b4);
...
/* Location:              C:\Users\MARTIN\Downloads\intgapp3_231.jar!\com\hp\ilo2\intgapp\locinfo.class
